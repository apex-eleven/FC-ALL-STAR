...
function credited(
  ...
  reason: Extract<WalletReason, 'shop' | 'admin-grant' | 'mission' | 'starpass' | 'gacha'>,
  by?: string,
...
/**
 * Hands over a reward list outside a purchase — mission, chest, Star Pass, and gacha payouts. Same
