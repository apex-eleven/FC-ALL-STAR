...
export const METRICS: readonly MissionMetricInfo[] = [
  ...
  { metric: 'league-play', label: 'ลีก · แข่ง', template: 'แข่งลีก {n} นัด', route: 'league' },
  { metric: 'league-win', label: 'ลีก · ชนะ', template: 'ชนะในลีก {n} นัด', route: 'league' },
...
export function defaultMissions(): MissionConfig {
  return {
    ...
    missions: [
      ...
      // The league plays itself every few minutes, so its target is set high.
      mission('w-league', 'weekly', 'league-win', 100, 30, [{ kind: 'gem', amount: 200 }]),
